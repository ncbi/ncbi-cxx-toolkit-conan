...
class NcbiCxxToolkit(ConanFile):
    ...
    @property
    def _components_filename(self):
        return "components.yml"

    def export(self):
        copy(self, self._components_filename,
    ...
    def package_info(self):
        ...
        components = yaml.safe_load(load(self, os.path.join(self.recipe_folder, self._components_filename)))["components"]
        ...
        self.cpp_info.set_property("cmake_build_modules",
            [os.path.join("res", "build-system", "cmake", "CMake.NCBIpkg.conan.cmake")])
